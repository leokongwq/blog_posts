...
layout: post
comments: true
title: java-设计模式之-装饰者模式
date: 2016-11-25 22:22:29
tags:
- java
categories:
- 设计模式
...
{% asset_img Decorator.jpg %}

### 时序图

{% asset_img seq_Decorator.jpg %}
...
{% asset_img Decorator_eg.jpg %}

{% asset_img seq_Decorator_eg.jpg %}
