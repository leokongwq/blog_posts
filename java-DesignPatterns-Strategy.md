...
策略模式(Strategy Pattern)：定义一个算法族，将每一个算法独立封装起来，并让它们可以相互替换。策略模式让算法独立于使用它的客户而变化，也称为政策模式(Policy)。
...
{% asset_img Strategy.jpg %}

### 时序图

{% asset_img seq_Strategy.jpg %}
